  ...
  return (
    <div className='flex flex-col gap-14'>
      ...
      <div className='bg-white lg:container'>
        <div className='bg-[#f6f6f9] grid grid-cols-1 lg:grid-cols-5 lg:gap-10 gap-14 container py-10'>
          <div className='lg:col-span-2'>
            <Image width={500} height={500} className='h-full w-full object-cover' src="/igcse/Student_1-1.jpg" alt="igcse" />
