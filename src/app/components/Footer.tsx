...
const Footer: React.FC<FooterProps> = ({}) => {
  ...
  const navigationSocialCS = [
    {
      name: "Facebook",
      href: "https://www.facebook.com/iwsonlinebangladesh/",
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/company/iws-bangladesh/",
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/iwsbangladesh/",
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "X",
      href: "https://x.com/iwsbangladesh",
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path d="M 2.3671875 3 L 9.4628906 13.140625 L 2.7402344 21 L 5.3808594 21 L 10.644531 14.830078 L 14.960938 21 L 21.871094 21 L 14.449219 10.375 L 20.740234 3 L 18.140625 3 L 13.271484 8.6875 L 9.2988281 3 L 2.3671875 3 z M 6.2070312 5 L 8.2558594 5 L 18.033203 19 L 16.001953 19 L 6.2070312 5 z" />
        </svg>
  ...
  const socialMediaLinks = pathname.includes("/partners/cs")
    ? navigationSocialCS
    : navigationSocialDefault;
  return (
          ...
          <div className="flex flex-col justify-center items-center gap-8 lg:items-start md:items-start">
            ...
            <div className="flex w-full mt-5 flex-col gap-3 justify-center items-center lg:items-start md:items-start">
              ...
              <div className="text-[15px] text-gray-400 mt-6">
                Graphics by{" "}
                <Link className="text-blue-600" href="https://icons8.com/">
                  Icons8
                </Link>
              </div>
            </div>
