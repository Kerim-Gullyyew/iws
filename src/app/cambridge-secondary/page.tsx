    ...
    <div className='py-14 lg:py-24 animate-fade-in'>
      ...
      <div className='pt-20 flex flex-col gap-14'>
        <div className='container flex flex-col gap-5'>
          <h1 className='text-center text-h1 text-blue-900 font-bold tracking-tight'>{"Guiding Students to Success: IWS Online School's Middle Cambridge Programme"}</h1>
        </div>
        ...
        <div className='bg-white lg:container'>
          <div className='bg-indigo-50 grid grid-cols-1 lg:grid-cols-5 lg:gap-10 '>
            ...
            <div className='container lg:col-span-3 flex flex-col gap-5 py-10 justify-center'>
              <h1 className='text-h1 font-bold text-blue-900'>Structured Learning Journey from Age 11</h1>
              <p className='text-p text-blue-600'>Cambridge Secondary at IWS Online School</p>
              <p className='text-p leading-10 text-gray-800 pt-4'>Embark on a well-defined path of Middle Education, commencing at age 11 and culminating in the prestigious Cambridge I/GCSE examinations. This educational journey is divided into Middle (3 years) and I/GCSE (2 years).</p>
            </div>
          </div>
