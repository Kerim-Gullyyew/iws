    ...
    <>
      ...
      <div className="py-14 lg:py-24 animate-fade-in">
          ...
          <div className="gap-10 sm:gap-14 flex-col flex justify-center">
            <div className="flex">
              <div className="relative bg-blue-200 text-blue-700 font-semibold text-lg sm:text-[24px] px-4 py-2 rounded-lg">
                IWS AND OMB PARTNERSHIP
              </div>
            </div>

            <h1 className=" leading-[50px] lg:leading-[70px] text-[35px] lg:text-[50px] sm:text-[40px] ">
              25% Scholarship for Students in Nigeria
            </h1>

            <p className="leading-[32px] text-[18px] sm:text-[24px]">
              {
                "Exclusive Opportunity for Students in Nigeria! We've partnered with OMB Corporate Trust to bring a 25% scholarship to students in Nigeria, making it easier to access world-class education through IWS Online School."
              }
            </p>
        ...
        >
          <div className="flex flex-col gap-3 md:flex-row md:justify-between md:items-center">
            ...
            <p className="md:flex-1">
              {
                "Getting started with IWS Online School through our partnership with OMB Corporate Trust is simple and straightforward. Follow these steps to access high-quality education at a discounted rate, sponsored by OMB Corporate Trust."
              }
            </p>
          </div>
              ...
              <div className="bg-white flex-1 flex gap-10 justify-between flex-col m-[3px] p-3 rounded-b-xl">
                <div className="flex flex-col gap-4">
                  <h3 className="text-[20px] text-center font-[500] leading-7">
                    Contact the OMB Team in Nigeria
                  </h3>
          ...
          <div className="pt-20 flex flex-col md:flex-row md:justify-between gap-10">
            <div className="md:w-1/2 md:max-w-lg">
              ...
              <div>
                <p>
                  {
                    "Don't miss out on this exclusive opportunity. Reach out now to secure your 25% scholarship and begin your learning journey with IWS and OMB Corporate Trust."
                  }
                </p>
              </div>
            </div>
        ...
        <div
          ...
          id="what-awaits"
        >
          <h2 className="  text-center ">What awaits you at OMB?</h2>
          ...
          <div className="grid grid-cols-6 pt-8 gap-8 sm:gap-10 sm:pt-12 md:gap-8 lg:gap-6">
            <div className="overflow-hidden h-full justify-between gap-10 flex flex-col px-6 py-8 rounded-xl col-span-6 md:col-span-2 bg-[#F1F9EC]">
              <h3 className="   tracking-wide">Visionary Educators of OMB</h3>
