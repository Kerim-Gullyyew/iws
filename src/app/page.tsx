      ...
      <div className='pt-20 container'>
        ...
        <div className="grid grid-cols-6 pt-8 gap-8 sm:gap-10 sm:pt-12 md:gap-8 lg:gap-6">
          ...
          <div className="relative gap-10 flex flex-col px-6 py-8 rounded-xl col-span-6 md:col-span-2 bg-pink-100">
            <Image width={1000} height={1000} className="absolute -top-10 w-56 md:w-36 md:right-0 object-contain z-30" src="/await/4.webp" alt="Hero Image width={1000} height={1000}" />
          ...
          <div className="relative gap-10 flex flex-col px-6 py-8 rounded-xl col-span-6 md:col-span-2 bg-amber-100">
            <Image width={1000} height={1000} className="absolute -top-10 w-56 md:w-36 md:right-0 object-contain z-30" src="/await/5.webp" alt="Hero Image width={1000} height={1000}" />
          ...
          <div className="overflow-hidden gap-10 md:gap-0 flex flex-col md:flex-row-reverse md:items-center rounded-xl col-span-6  bg-sky-100">
            <Image width={1000} height={1000} className="object-contain self-center md:w-3/5 max-w-sm" src="/await/6-1024x399.webp" alt="Hero Image width={1000} height={1000}" />
