      ...
      <div className='pt-20 flex flex-col md:flex-row lg:flex-row-reverse gap-5'>
        ...
        <div className='flex flex-col gap-5 justify-center'>
          ...
          <div className='flex flex-col gap-8'>
            ...
            <p className='text-p'>There may be occasional additional fees including (but not limited to): extracurricular activities, social events, trips, excursions, camps, and external examination fees. Wherever possible, all such additional fees will be communicated to you well in advance.</p>
            <p className='text-p'>A student is presumed to be enrolled for the next academic year or term if adequate notification is not received in writing by the school. Please refer to our Withdrawal section for details on notice periods.</p>
          </div>
