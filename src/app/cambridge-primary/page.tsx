      ...
      <div className="py-14 lg:py-24 animate-fade-in">
        <div className="gap-10 container sm:gap-14 flex-col flex justify-center items-center lg:flex lg:flex-row">
          <div className="flex flex-col gap-5">
            ...
            <h1 className=" text-blue-900">
              Online Primary School for Ages 7-11 – Flexible, Accredited
              Learning
            </h1>
            <p className=" ">
              IWS Online Primary School offers a Cambridge-accredited primary
              education for children aged 7-11. Our fully online platform
              ensures students receive a world-class education with flexibility
              to learn from home, guided by experienced teachers and a
              curriculum designed to foster curiosity and critical thinking.
            </p>

            <div className="flex flex-wrap gap-5">
              <Tooltip text="Join Our Online Primary School">
                <EnrollButton />
              </Tooltip>
              <Tooltip text="Learn More About Our Online Primary School.">
                <ContactButton />
              </Tooltip>
            </div>
          </div>
        ...
        <div className="pt-20 container">
          <div className="flex flex-col gap-6">
            ...
            <p className=" text-center">
              Explore a range of engaging subjects in our Online Primary School.
              Each subject is crafted to support young learners as they grow
              academically and socially, preparing them for future educational
              stages.
            </p>
          </div>
        ...
        <div className="pt-20 container">
          <h2 className="  text-center ">
            Why Choose IWS Online Primary School?
          </h2>
        ...
        <div className="pt-20">
          <div className="container grid grid-cols-1 sm:grid-cols-2 gap-9">
            ...
            <div>
              <h2 className="pt-3">Why Choose an Online Primary School?</h2>
              <ul className=" list-disc list-inside pt-9">
                <li>
                  Flexible Learning at Home: Ideal for families who need a
                  flexible schedule.
                </li>
                <li>
                  Accessible to All Locations: IWS Online Primary School serves
                  students globally, making quality education accessible to
                  children in remote areas or families who frequently relocate.
                </li>
                <li>
                  Individualised Attention and Support: Personalised learning
                  plans and dedicated support ensure that each child progresses
                  at their own pace.
                </li>
                <li>
                  Parental Involvement Encouraged: Our online platform keeps
                  parents engaged with regular updates and resources to support
